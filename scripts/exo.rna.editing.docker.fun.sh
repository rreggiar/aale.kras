...
for BEDFILE in sleuth.alu.bed; do
#for BEDFILE in gencode.as1.bed kras.alu.bed kras.mer.bed sz.sx.sx1.y.bed; do
  docker run \
    -u $(id -u ${USER}):$(id -g ${USER})\
    -v '/public/groups/kimlab/aale.luad.exo/aale.exo.data/bam.files':'/data/input_files'\
    -v '/public/groups/kimlab/aale.kras/data/bulk.rna.seq/aale/output/exo.sleuth.alu.edit.out':'/data/output_dir'\

...
set_my_theme <- function(base_size=7, base_family='Helvetica'){
  theme_set(theme_foundation(base_size = 7, base_family = 'Helvetica') + 
            theme(plot.title = element_blank(),
                panel.background = element_rect(colour = NA),
                plot.background = element_rect(colour = NA),
...
cell.Titer %>% 
  ...
  # ggsignif::geom_signif(comparisons = list(c('siCTRL','siKRAS')), 
  #                       test = 't.test', vjust = 0) +
  # ggsignif::geom_signif(comparisons = list(c('siCTRL', 'siMDA5')), 
  #                       test = 't.test', vjust = 1, ) +
  # ggsignif::geom_signif(comparisons = list(c('siCTRL', 'siRIG-I')), 
  #                       test = 't.test', vjust = 0.30) +
  scale_x_discrete(limits=c('siCTRL','siKRAS', 'siMDA5', 'siRIG-I')) + 
  xlab('') + set_my_theme()
                         

titerPlot
ggsave('../figures/fig.1/ctg.2.5x2.5.pdf', height = 3, width = 3, units = 'in')
